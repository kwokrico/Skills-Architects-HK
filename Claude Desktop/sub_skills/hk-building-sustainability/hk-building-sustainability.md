...
| Interiors v1.0 | Fit-out of leased spaces | HKGBC |
| Neighbourhood v1.0 | Master plan / district scale | HKGBC |
...
## 4. Energy Code (EMSD BEC)

- **Building Energy Code (BEC)** administered by EMSD
- Mandatory for new non-domestic buildings and major A&A works
- Key prescriptive requirements: lighting power density, HVAC COP, OTTV/RTTV
- BEAM Plus EU credits require performance above BEC baseline
...
*Sources: BEAM Plus NB v2.0 (HKGBC), BEAM Plus EB v2.0, EMSD Building Energy Code 2021, ASHRAE 90.1-2022 (CZ 1A), HK Observatory climate data.*