---
name: hk-heritage-conservation
description: Activate for Hong Kong heritage conservation workflows, including AMO/AAB processes, Heritage Impact Assessment (HIA), graded historic buildings, adaptive reuse submissions, intervention strategy, and conservation guideline compliance beyond basic listing checks.
disable-model-invocation: true
---

# HK Heritage Conservation

Advanced guidance for Hong Kong heritage conservation projects: statutory context, AMO/AAB engagement, HIA process, adaptive reuse submission strategy, and technical conservation principles for design and approvals.

For **Heritage grading / HIA / reuse**, use `hk-heritage-conservation`. For other topics, see the routing table below.

## When to Use This Skill

Graded buildings, AMO/AAB, HIA, adaptive reuse submissions.

| Question type | Use this skill | Use instead |
|---------------|----------------|-------------|
| Heritage grading / HIA / reuse | `hk-heritage-conservation` | `—` |
| Design theory only | `—` | `hk-design-theory` |
| Standard GFA for new build | `—` | `hk-building-codes` |
---

## 1. Conservation Governance in Hong Kong

### 1.1 Key Bodies and Their Roles
- **AAB (Antiquities Advisory Board):** Advises on grading of historic buildings (Grade 1/2/3) and wider heritage policy matters.
- **AMO (Antiquities and Monuments Office):** Technical authority for heritage assessment, monument protection administration, and conservation guidance.
- **Antiquities Authority (Development Bureau):** Statutory decision-maker under the Antiquities and Monuments Ordinance.
- **Planning / Buildings / Lands authorities:** Planning, building safety, lease and land controls still apply to adaptive reuse works.

### 1.2 Main Legal Framework
- **Antiquities and Monuments Ordinance (Cap. 53):** Declared monument protection, permits for works/alteration where applicable.
- **Buildings Ordinance (Cap. 123):** Structural, fire safety, MOE, barrier-free access, and submission pathway for alteration works.
- **Town Planning Ordinance (Cap. 131):** OZP uses, planning permission (e.g., section 16) where proposed use/intensity requires it.
- **Land lease conditions:** Site-specific lease terms may constrain use or alterations.
...
### 2.1 Practical Meaning of Grades
- **Grade 1:** Outstanding merit; every effort should be made to preserve if possible.
- **Grade 2:** Special merit; selective preservation encouraged.
- **Grade 3:** Some merit; preservation in some form can be considered.
...
## 3. Heritage Impact Assessment (HIA) Workflow

### 3.1 Typical HIA Structure
...
- Building code deep checks -> `hk-building-codes`
- Fire strategy and MOE trade-offs -> `hk-fire-life-safety`
- Planning permission path -> `hk-spatial-planning`
- A&A documentation execution -> `hk-alterations-additions`
